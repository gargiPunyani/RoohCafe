...
const UpcomingEvents = () => {
  ...
  return (
    ...
    <div className='eventSlider relative borderRadius12'>
        ...
        <div><Link className='link' to="/reservation">
          <button className= "bookTableBtn upcomingEventBook  absolute secondaryColor borderRadius8 font16">Book Now</button></Link>
        </div>
        <div className='eventBooking transition absolute textCenter'>
            <h3 className='h3'> To Book Your Seat fill the form</h3>
            <h3 className='mt5'> Our Manager will contact you soon</h3>
        ...
        <div className='secondaryImage mt5 secondaryColor font24'>
    ...
    <div className='eventHappeningSoon'>
        ...
        <div className='eventBooking transition absolute textCenter'>
            ...
            <h3 className='mt5's>Our Manager will contact you soon</h3>
            <Link className='link' to={"/reservation"}>
